...
export const TRANSPO_PIPELINE_STAGES: TranspoPipelineStageDef[] = [
  ...
  },
  {
    ...
    navItemIds: ["carrier-opportunities", "qualified-targets"],
    primaryHref: "/admin/intelligence/transpo/carrier-opportunities",
    primaryActionLabel: "Open Carrier Opportunities",
  },
  {
    id: "service_deficits",
    order: 5,
    ...
    navItemIds: ["market-gaps", "service-deficits", "data-confidence", "opportunity-radar", "network-plays", "county-opportunities", "demand-generators", "provider-capacity", "missing-evidence", "opportunity-synthesis", "research-queue"],
