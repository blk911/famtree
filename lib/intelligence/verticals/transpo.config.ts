...
export const transpoConfig: VerticalConfig = {
  ...
  enabledTools: ["source-ingest", "source-runs", "evidence", "resolver", "carriers", "verification", "opportunities", "qualified-targets", "market-dashboard", "market-gaps", "harvest", "prospects"],
