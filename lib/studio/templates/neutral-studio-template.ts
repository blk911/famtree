...
export const NEUTRAL_STUDIO_TEMPLATE = {
  ...
  data: {
    ...
    businessName: "Your community name",
    tagline: "Trusted private space for your members",
    description:
      "A focused home for your PTA, team, church, club, or local group — announcements, events, and private communication in one calm place.",
    email: "you@example.com",
    phone: "",
    address: "",
    heroImageUrl: "",
    serviceType: "Community · Local group",
    accentHex: "#78716c",
    ownerDisplayName: "Your name",
    introTitle: "How Studios works",
    introBullets: [
