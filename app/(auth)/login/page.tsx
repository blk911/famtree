...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <style>{`
        .AMIHUMAN.NET-login-input:focus { border-color: #f59e0b !important; box-shadow: 0 0 0 3px rgba(245,158,11,0.14); }
        .AMIHUMAN.NET-login-submit:hover { opacity: 0.9; }
      `}</style>
      ...
      <div className="auth-card space-y-6" style={{
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              className="field-input AMIHUMAN.NET-login-input"
              type="email"
          ...
          <div>
            ...
            <div className="relative">
              <input
                className="field-input pr-10 AMIHUMAN.NET-login-input"
          ...
          <button type="submit" className="btn-primary w-full AMIHUMAN.NET-login-submit" disabled={loading} style={{
