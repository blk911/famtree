"use client";
// Carrier opportunities — scored carrier master (qualify stage).
...
export default function TranspoCarrierOpportunitiesPage() {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "28px 20px 60px" }}>
      <TranspoIntelligenceNav currentTool="carrier-opportunities" />
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: "#78716c", margin: 0, maxWidth: 640, lineHeight: 1.55 }}>
          ...
          missing web/social presence, and local market — with a recommended sales play.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <div style={{ fontWeight: 700, color: "#44403c", marginBottom: 4 }}>
            No carrier opportunities yet
          </div>
          Promote records into the Carrier Master first.
        </div>
      ) : (
        <div style={{
          background: "#fff",
          ...
          <div style={{
            ...
            <div style={{ fontSize: 11, color: "#78716c" }}>
              Showing {sortedVisible.length} of {opportunities.length} from {carrierCount} carriers
              {filter === "all" ? " · rejected hidden" : ""}.
            </div>
          </div>
