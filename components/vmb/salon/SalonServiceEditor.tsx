...
import { formatDuration, formatPrice } from "@/components/vmb/salon/SalonServiceListItem";
      ...
      <div className="vmb-salon-services__field-grid">
        <label className="vmb-salon-services__field">
          ...
          <span className="vmb-salon-services__default-note">
            Admin default: {formatPrice(service.adminBasePriceCents)}
          </span>
        </label>
        ...
        <label className="vmb-salon-services__field">
          ...
          />
          <span className="vmb-salon-services__default-note">
            Admin default: {formatDuration(service.adminDurationMinutes)}
          </span>
        </label>
      </div>
            ...
            {service.addons.map((addon) => {
              ...
              return (
                <li key={addon.addonId} className="vmb-salon-services__addon-editor-row">
                  ...
                  <p className="vmb-salon-services__default-note">
                    Admin default: {formatPrice(addon.defaultPriceCents)}
                  </p>
                </li>
              );
            })}
