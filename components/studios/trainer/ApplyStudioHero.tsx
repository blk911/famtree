...
function StudioHeroTrainingCards() {
  return (
    <div className="mt-4 min-w-0 space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {trainingCards.map((card) => (
          <div key={card.title} className="overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-black/[0.04]">
            {/* eslint-disable-next-line @next/next/no-img-element -- static marketing assets in /public */}
